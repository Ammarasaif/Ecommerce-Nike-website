...
import { gear1 } from "@/app/Cart/Data/detail";
...
export function GearCarousel1() {
  return (
    <div className="w-full flex justify-center md:justify-start">
      ...
      <div className="absolut bottom-[390px] w-[300px] h-[393px] left-12 md:bottom-[430px] md:right-14 right-14 lg:bottom-[310px] xl:bottom-[380px]">
        <CarouselPrevious />
        <CarouselNext />
        </div>
